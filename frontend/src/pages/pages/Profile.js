  ...
  return (
    <Card mb={6}>
      <CardContent>
        ...
        <Centered>
          <Avatar alt={sessionStorage.getItem('username')} src="" />
          <Typography variant="body2" component="div" gutterBottom>
            <Box fontWeight="fontWeightMedium">{sessionStorage.getItem('username')}</Box>
            <Box fontWeight="fontWeightRegular">{sessionStorage.getItem('email')}</Box>
          </Typography>
